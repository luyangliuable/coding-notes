	...
	//echo $sql;
	  ...
	  $_SESSION['user_time'] = time();
        ...
        if ($name !="Admin") {
          ...
          echo "<li class='navbar-nav mr-auto mt-2 mt-lg-0' style='padding-left: 30px;'>";
	   //item #1
	   ...
	   //item #3
          echo "<li class='nav-item'>";
          echo "<a class='nav-link' href='unsafe_task_load.php'>Add Task</a>";
          echo "</li>";
	   //item #4
          echo "<li class='nav-item'>";
          echo "<a class='nav-link' href='unsafe_view_order.php'>Set View Preference</a>";
          echo "</li>";
	  //item #5
          echo "<li class='nav-item'>";
          echo "<a class='nav-link' href='unsafe_tasks_view.php'>View Tasks</a>";
          echo "</li>";
